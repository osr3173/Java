...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<String>> login(@RequestBody UserCustom userCustom) {
        ...
        try {
            ...
            // 출입관리부에 작성
            SecurityContextHolder.getContext().setAuthentication(authentication);  //getContext : 전역


            // response body
            ApiResponse apiResponse = new ApiResponse(ResponseStatus.SUCCESS, "성공 했음", token);
